...
def prepare_chat_data(working_directory, train_enc, train_dec, enc_dev, dec_dev , enc_vocabulary_size, dec_vocabulary_size, tokenizer=None):
    ...
    enc_dev_ids_path = enc_dev + (".ids%d" % enc_vocabulary_size)
    dec_dev_ids_path = dec_dev + (".ids%d" % dec_vocabulary_size)
    data_to_token_ids(enc_dev, enc_dev_ids_path, enc_vocab_path, tokenizer)
    data_to_token_ids(dec_dev, dec_dev_ids_path, dec_vocab_path, tokenizer)
